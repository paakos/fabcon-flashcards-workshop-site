...
const topicsURL = "https://safabricflashcards.blob.core.windows.net/$web/topics.json"
...
const QAsURL = "https://safabricflashcards.blob.core.windows.net/$web/generated-QAs.json"
